&lt;!--
title: Password Protect a PDF on iPhone — Lock It in Seconds | PDFlow
meta: Add a password to any PDF on iPhone with PDFlow. Protect sensitive documents before sharing. No subscription — one-time purchase. Download free on the App Store.
url: /protect-pdf-iphone
primary keyword: password protect pdf iphone
secondary: lock pdf iphone, how to password protect a pdf on iphone, add password to pdf iphone, encrypt pdf ios
...
## Table of Contents
- [Password Protect a PDF on iPhone with PDFlow](#pdflow)
- [Does iPhone Have a Built-In PDF Password Tool?](#built-in)
- [How to Lock a PDF Using the iOS Files App](#files-app)
- [When Should You Password Protect a PDF?](#when-to-use)
- [Frequently Asked Questions](#faq)
- [Why PDFlow?](#why-pdflow)

---

## How to Password Protect a PDF on iPhone with PDFlow {#pdflow}
...
Other limitations:
- Cannot remove the password later from within the Files app (requires a third-party tool like PDFlow's [Unlock tool](/unlock-pdf-iphone))
...
2. Navigate to the folder containing your PDF (must be **On My iPhone** — not iCloud Drive)
3. Tap to open the PDF
4. Tap the **downward arrow** next to the filename at the top
5. Tap **Lock PDF**
6. Enter a password in the Password field
7. Re-enter it in the Verify field
8. Tap **Done**
...
Not directly. To change a PDF password, you first need to remove the existing password using PDFlow's [Unlock tool](/unlock-pdf-iphone), then re-protect it with the new password using the Protect tool. This two-step process takes under a minute.
...
You need to remove the existing password first. Use PDFlow's [Unlock tool](/unlock-pdf-iphone) to strip the current password, then use the Protect tool to add a new one.

---

## Why PDFlow for Password Protecting PDFs on iPhone? {#why-pdflow}

[Adobe Acrobat](https://www.adobe.com/acrobat/hub/password-protect-pdfs-iphone.html) charges $9.99/month for PDF protection features on iPhone. The built-in iOS method only works on locally stored files and can't remove passwords. Online tools require uploading your sensitive documents to a third-party server — exactly what you don't want for documents you're trying to secure.
