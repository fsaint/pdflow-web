&lt;!--
title: Split PDF on iPhone — Extract Pages in Seconds | PDFlow
meta: Split a PDF on iPhone with PDFlow. Extract pages, separate a large file, or save a page range. No subscription — one-time purchase. Download free on the App Store.
url: /split-pdf-iphone
primary keyword: split pdf iphone
secondary: how to split a pdf on iphone, separate pdf pages iphone, extract pages from pdf iphone, split pdf into separate pages iphone
word count target: 1,200-1,500
schema: HowTo
--&gt;

# How to Split a PDF on iPhone (Extract Pages in Seconds)
...
## Table of Contents
- [Split a PDF on iPhone with PDFlow](#pdflow)
- [Does iPhone Have a Built-In PDF Splitter?](#built-in)
- [How to Split a PDF Using the iOS Print Trick](#print-trick)
- [Split vs. Extract — What's the Difference?](#split-vs-extract)
- [Frequently Asked Questions](#faq)
- [Why PDFlow?](#why-pdflow)

---

## How to Split a PDF on iPhone with PDFlow {#pdflow}
...
Not directly. Unlock the password first using PDFlow's [Unlock tool](/unlock-pdf-iphone), then split the file. You can re-protect the output files with the [Protect tool](/protect-pdf-iphone) if needed.
...
## Why PDFlow for Splitting PDFs on iPhone? {#why-pdflow}

[Adobe Acrobat](https://www.adobe.com/acrobat/hub/how-to-split-a-pdf-on-an-iphone.html) and [PDF Expert](https://pdfexpert.com/how-to-split-pdf-pages) both offer PDF splitting — locked behind subscriptions of $9.99–$19.99/month. The free iOS Print trick works but is unintuitive and can't handle non-contiguous page selection.
...
- [Merge PDFs on iPhone](/merge-pdf-iphone) — recombine files in a different order
- [Remove pages from a PDF](/remove-pages-pdf-iphone) — trim pages without splitting into multiple files
- [Compress the PDF](/compress-pdf-iphone) — reduce file size of the split output
